...
## 2026-07-29 - Reflected XSS in Flask Error Handlers
**Vulnerability:** Unescaped error messages in Flask string tuple returns.
**Learning:** Flask defaults to text/html when returning string tuples, exposing unsanitized e.description to XSS.
**Prevention:** Always wrap returned error messages in escape() from markupsafe.
